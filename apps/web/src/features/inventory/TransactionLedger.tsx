        ...
        <section className="rounded-xl border border-border bg-surface p-5 shadow-sm">
          ...
          <form onSubmit={(e) => { void handleRecordTransaction(e); }} className="space-y-3">
            ...
            {isAddingNew && (
              <div className="space-y-3 rounded-lg border border-border bg-surface-muted p-3">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-lg bg-action px-4 py-2 text-sm font-medium text-action-foreground transition-colors hover:bg-action/90"
                >
                  Create &amp; select
                </button>
              </div>
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-action px-4 py-2.5 text-sm font-medium text-action-foreground transition-colors hover:bg-action/90 disabled:opacity-50"
            >
